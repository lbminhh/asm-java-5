                        ...
                        <c:forEach items="${list}" var="item" varStatus="loop">
                            <tr>
                                ...
                                <td style="width: 1px;" class="text-nowrap">
                                    ...
                                    <a class="btn btn-warning" href="/user/edit/${item.id}">Sửa</a>
                        ...
                        <ul class="pagination justify-content-center">
                            <li class="page-item">
                                <a class="page-link"
                                    ...
                                    <c:if test="${currentPage > 1}">
                                        <c:if test="${isSearch && isSearch != null}">
                                            href="/user/list/search?page=${currentPage - 1}&value=${valueSearch}"
                                        </c:if>
                                    </c:if>
                                    tabindex="-1"
                                    aria-disabled="true">
